...
This package contains the URDF description of the Rx200 robot. You can download it from [here](https://github.com/ncbdrck/rx200_supporting_materials) and follow the instructions to install it.
```shell
cd ~/catkin_ws/src
