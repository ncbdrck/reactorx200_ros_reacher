...
# register(
#     id='RX200ReacherGoalEnvSim-v15',
#     entry_point='reactorx200_ros_reacher.sim.task_envs.reactorx200_reacher_goal_sim_v1.5:RX200ReacherGoalEnv',
#     max_episode_steps=100,
# )

"""
This is the v1.5 of the RX200 Reacher Task Environment. Following are the new features of this environment frpm v1.0:
    * Removed tacking action in the environment loop
    * Pause the robot after each action cycle (when we call observations)
"""
...
class RX200ReacherGoalEnv(reactorx200_robot_goal_sim_v1.RX200RobotGoalEnv):
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        So observation space is a dictionary with 
            observation: (5+[3*2]+1) 12 elements
