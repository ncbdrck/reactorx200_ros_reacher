...
# Custom robot env
from reactorx200_ros_reacher.real.robot_envs import reactorx200_robot_goal_real
...
class RX200ReacherGoalEnv(reactorx200_robot_goal_real.RX200RobotGoalEnv):
    """
